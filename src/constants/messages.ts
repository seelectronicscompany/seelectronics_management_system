...
কাস্টমার কেয়ার: ${contactDetails.customerCare}`,
  CUSTOMER_REGISTRATION: `স্বাগতম প্রিয় গ্রাহক {name}, \nএস ই ইলেকট্রনিকস থেকে পন্য ক্রয় করার জন্য আপনাকে ধন্যবাদ। আপনার একটি প্রোফাইল তৈরি হয়েছ। কাস্টমার আই ডি : {customer_id} এবং ইনভয়েস নম্বর: {invoice_number} দিয়ে লগিং করতে লিংকটি ক্লিক করুন। পন্যের তথ্য , সার্ভিস যাবতীয় সকল কিছু  দেখতে লগিং করে হোম পেইজে রাখুন।\n
