    ...
    if (variant === "details") {
      return (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          ...
          <a
            href={`/staff/resume?id=${staffData.staffId}`}
            className="flex flex-col items-center justify-center gap-2 p-4 bg-purple-50 text-purple-600 rounded-md hover:bg-purple-100 transition-colors border border-purple-100"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
