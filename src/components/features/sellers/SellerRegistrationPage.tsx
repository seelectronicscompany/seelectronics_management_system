...
function Hero({ kicker, title, subtitle }: { kicker: string; title: string; subtitle: string }) {
  return (
    <section className="bg-[#0b3d91] bg-[radial-gradient(120%_90%_at_10%_0%,#1b5fd0_0%,#0b3d91_55%,#072a66_100%)] text-white px-5 pt-5 pb-16 rounded-b-[16px] relative overflow-hidden">
  ...
  if (done) {
    return (
      <div className="min-h-screen bg-[#eef3fb] flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-white rounded-md p-8 text-center shadow-[0_10px_30px_rgba(11,61,145,0.12)] animate-in zoom-in-95 duration-500">
          ...
          <Link href="/" className="mt-8 inline-flex w-full h-12 items-center justify-center rounded-md bg-[#0b3d91] bg-[linear-gradient(110deg,#0a2f70_0%,#1b5fd0_100%)] text-white font-extrabold shadow-[0_10px_30px_rgba(10,47,112,0.35)]">হোম পেজে ফিরে যান</Link>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#eef3fb]">
        <div className="max-w-[560px] mx-auto pb-10">
          ...
          <div className="px-2 -mt-10 relative flex flex-col gap-2.5">
            <div className="bg-white rounded-md p-4 shadow-[0_10px_30px_rgba(11,61,145,0.12)] flex flex-col gap-1">
              ...
              {requirements.map((r) => (
                <div key={r.text} className="flex items-center gap-3.5 py-3 border-t border-[#eef1f6] first-of-type:border-0">
                  <span className="size-11 rounded-md bg-[#e8f1ff] text-[#1f7cf0] flex items-center justify-center shrink-0"><r.icon size={20} /></span>
            ...
            <label className="bg-white rounded-md p-4 shadow-[0_4px_18px_rgba(11,61,145,0.06)] flex items-start gap-3 cursor-pointer">
    ...
    <div className="min-h-screen bg-[#eef3fb]">
      <div className="max-w-[760px] mx-auto pb-10">
        ...
        <div className="px-2 -mt-10 relative">
          <div className="bg-white rounded-md p-4 sm:p-6 shadow-[0_10px_30px_rgba(11,61,145,0.12)]">
