...
export default function PaymentReceiptTemplate({
  ...
  data: PaymentReceiptTemplateProps;
}) {
  return (
    <div
    ...
    >
      ...
      <div className="space-y-10 px-6">
        ...
        <div>
          <h2 className="text-lg font-bold text-gray-900 mb-3  pb-1">
            Sender Information
          </h2>
              ...
              {data.paymentMethod === "bank" && data.senderBankInfo && (
                <>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-400 px-4 py-2.5">
                      {data.senderBankInfo.accountHolderName}
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-400 px-4 py-2.5 font-bold bg-gray-50 uppercase text-xs">
                    ...
                    <td className="border border-gray-400 px-4 py-2.5">
                      {data.senderBankInfo.accountNumber}
                    </td>
                  </tr>
                </>
              )}
          ...
          <table className="w-full border-collapse">
            <tbody>
              ...
              {data.paymentMethod === "bank" && data.receiverBankInfo && (
                <>
                  <tr>
                    ...
                    <td className="border border-gray-400 px-4 py-2.5">
                      {data.receiverBankInfo.bankName}
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-400 px-4 py-2.5 font-bold bg-gray-50 uppercase text-xs">
                    ...
                    <td className="border border-gray-400 px-4 py-2.5">
                      {data.receiverBankInfo.accountNumber}
                    </td>
                  </tr>
                </>
              )}
              ...
              <tr className="bg-gray-100">
                <td className="border border-gray-400 px-4 py-3 font-bold uppercase text-sm">
                  Payment Received :
                </td>
                <td className="border border-gray-400 px-4 py-3 font-black text-xl text-blue-900">
                  {data.amount} TK
                </td>
              </tr>
            </tbody>
