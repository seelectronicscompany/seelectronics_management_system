...
export function CustomerHeader() {
  ...
  return (
    <header className={`sticky top-0 z-50 text-white overflow-hidden w-full ${isHome ? "bg-[#0b3d91] bg-[radial-gradient(120%_90%_at_10%_0%,#1b5fd0_0%,#0b3d91_55%,#072a66_100%)]" : "bg-[#0A1A3A]"}`}>
