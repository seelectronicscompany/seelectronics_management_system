...
const NATIONAL_SERVICES = [
  {
    ...
    number: "999",
    description: "পুলিশ, ফায়ার সার্ভিস এবং অ্যাম্বুলেন্সের জন্য একটি সমন্বিত হেল্পলাইন।",
    icon: ShieldAlert,
    color: "text-red-600",
    bgColor: "bg-red-50",
  ...
  },
  {
    ...
    number: "16263",
    description: "২৪ ঘণ্টা অভিজ্ঞ ডাক্তারদের ফ্রি স্বাস্থ্য পরামর্শ ও অ্যাম্বুলেন্স সেবা।",
    icon: Activity,
  ...
  },
  {
    ...
    number: "109",
    description: "নারী ও শিশু নির্যাতন প্রতিরোধে অবিলম্বে সহায়তার জন্য কল করুন।",
    icon: UserCheck,
    color: "text-pink-600",
    bgColor: "bg-pink-50",
  ...
  },
  {
    ...
    number: "106",
    description: "দুর্নীতি বা অনিয়ম সম্পর্কে সরাসরি অভিযোগ বা তথ্য প্রদান করুন।",
    icon: Scale,
  ...
  },
  {
    ...
    number: "105",
    description: "স্মার্ট কার্ড এবং এনআইডি সংক্রান্ত যেকোনো তথ্যের জন্য কল করুন।",
    icon: Fingerprint,
  ...
  },
  {
    ...
    number: "1090",
    description: "বন্যা, ঘূর্ণিঝড় সহ প্রাকৃতিক দুর্যোগের আগাম সতর্কবার্তা জানতে।",
    icon: Wind,
...
const LOCAL_SERVICES_DATABASE: Record<string, Record<string, any[]>> = {
  "ঢাকা": {
    "ঢাকা": [
      { name: "ডিএমপি হেডকোয়ার্টার্স", helpBangla: "পুলিশ কন্ট্রোল রুম", number: "01320-040100", description: "ঢাকা মেট্রোপলিটন পুলিশ জরুরি সহায়তা", icon: ShieldCheck, color: "text-blue-700", bgColor: "bg-blue-50", borderColor: "border-blue-100" },
      { name: "ঢাকা মেডিকেল কলেজ", helpBangla: "ঢামেক জরুরি বিভাগ", number: "01732-601815", description: "দেশের বৃহত্তম সরকারি সাধারণ হাসপাতাল", icon: Hospital, color: "text-rose-600", bgColor: "bg-rose-50", borderColor: "border-rose-100" },
      { name: "সদরদপ্তর ফায়ার সার্ভিস", helpBangla: "ফায়ার কন্ট্রোল রুম", number: "02-9555555", description: "ফায়ার সার্ভিস ও সিভিল ডিফেন্স হেডকোয়ার্টার্স", icon: Flame, color: "text-orange-700", bgColor: "bg-orange-50", borderColor: "border-orange-100" },
      { name: "ন্যাশনাল হার্ট ফাউন্ডেশন", helpBangla: "হৃদরোগ জরুরি সেবা", number: "02-58051252", description: "হৃদরোগীদের জন্য বিশেষায়িত চিকিৎসা কেন্দ্র", icon: Stethoscope, color: "text-red-500", bgColor: "bg-red-50", borderColor: "border-red-100" },
    ],
    "নারায়ণগঞ্জ": [
      { name: "নারায়ণগঞ্জ মডেল থানা", helpBangla: "পুলিশ কন্ট্রোল রুম", number: "01320-107405", description: "নারায়ণগঞ্জ সদর এলাকার জন্য জরুরি পুলিশ সেবা", icon: ShieldCheck, color: "text-blue-700", bgColor: "bg-blue-50", borderColor: "border-blue-100" },
      { name: "৩০০ শয্যা হাসপাতাল", helpBangla: "ভিক্টোরিয়া জেনারেল হাসপাতাল", number: "01912-340623", description: "নারায়ণগঞ্জ জেলার প্রধান সরকারি হাসপাতাল", icon: Hospital, color: "text-rose-600", bgColor: "bg-rose-50", borderColor: "border-rose-100" },
    ]
  },
  "চট্টগ্রাম": {
    "চট্টগ্রাম": [
      { name: "সিএমপি হেডকোয়ার্টার্স", helpBangla: "চট্টগ্রাম পুলিশ সেবা", number: "01320-050100", description: "চট্টগ্রাম মেট্রোপলিটন পুলিশ জরুরি সহায়তা", icon: ShieldCheck, color: "text-blue-700", bgColor: "bg-blue-50", borderColor: "border-blue-100" },
      { name: "চমেক হাসপাতাল", helpBangla: "চট্টগ্রাম মেডিকেল জরুরি", number: "01732-401815", description: "চট্টগ্রামের প্রধান সরকারি সাধারণ হাসপাতাল", icon: Hospital, color: "text-rose-600", bgColor: "bg-rose-50", borderColor: "border-rose-100" },
    ]
  }
};
      ...
      <div className="flex flex-col gap-6 p-4 sm:p-6 text-gray-800 pb-24 font-sans">
          ...
          <div className="flex flex-col md:flex-row items-end gap-4">
            ...
            <div className="w-full md:w-auto flex-1 space-y-2">
              ...
              >
                ...
                {division && DIVISION_DATA[division].map((dist) => (
            ...
            {hasSelection && (
              <button
                onClick={() => { setDivision(""); setDistrict(""); }}
        ...
        {division && district && localServices.length === 0 && (
          <div className="p-8 rounded-md bg-amber-50 border border-amber-100 text-center space-y-3">
             ...
             <h3 className="text-md font-black text-amber-800 uppercase tracking-widest">দুঃখিত! এই এলাকায় স্থানীয় সেবা যুক্ত নেই</h3>
             <p className="text-sm text-amber-600/80 max-w-sm mx-auto">
               আপনার এলাকার জন্য আমাদের কাছে এখনো স্থানীয় নাম্বার নেই। অনুগ্রহ করে আমাদের সাথে শেয়ার করুন। <br /> 
        ...
        <div className="mt-4">
           {!hasSelection ? (
             <div className="flex items-center gap-3 mb-6">
                <h2 className="text-[14px] font-black text-gray-400 p-2 uppercase  ">জাতীয় জরুরি সেবা</h2>
                <div className="h-px flex-1 bg-gray-100" />
             </div>
           ) : (
             <div className="flex items-center gap-4 mb-8 mt-4">
                <div className="h-px flex-1 bg-gradient-to-r from-transparent to-gray-200" />
                <h2 className="text-[12px] font-black text-gray-400 uppercase  px-4">সাধারণ জরুরি নাম্বার</h2>
                <div className="h-px flex-1 bg-gradient-to-l from-transparent to-gray-200" />
             </div>
           )}
           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        <div className="mt-8 p-8 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-6 opacity-60 hover:opacity-100 transition-opacity">
            <div className="flex items-center gap-2 text-center md:text-left">
                ...
                <div>
                   <p className="text-[14px] font-black text-gray-400 uppercase  mb-1">তথ্যসূত্র ও নিরাপত্তা</p>
                   <p className="text-sm text-gray-500 max-w-md font-medium">সকল তথ্য সরকারি পোর্টাল থেকে সংগৃহীত। জরুরি মুহূর্তে ৯৯৯ নাম্বারে ডায়াল করাই সবচেয়ে নিরাপদ।</p>
                </div>
            </div>
            <button className="px-3 py-2 rounded-md border border-gray-200 text-[14px] font-black uppercase  text-gray-400 hover:text-brand hover:border-brand transition-all flex items-center gap-2 group">
                ভুল বা নতুন নাম্বার রিপোর্ট ক্লিক করুন <ExternalLink size={20} className="group-hover:translate-x-1 transition-transform" />
            </button>
        </div>
      </div>
    </CustomerLayout>
...
function ServiceCard({ service }: { service: any }) {
  return (
    <div className={`group relative overflow-hidden bg-white rounded-md border ${service.borderColor} p-6 hover:shadow-[0_20px_50px_rgba(0,0,0,0.08)] transition-all duration-500 transform hover:-translate-y-1`}>
      <div className="flex items-start justify-start mb-6 gap-4">
        <div className={`p-4 rounded-md ${service.bgColor} ${service.color} transition-all group-hover:scale-110 group-hover:rotate-3 duration-300 shadow-sm border border-black/5`}>
      ...
      <div className={`absolute bottom-0 right-0 w-24 h-24 ${service.bgColor} opacity-0 group-hover:opacity-30 rounded-tl-full transition-all duration-500 -mr-12 -mb-12 blur-2xl`} />
    </div>
  );
}
