      ...
      >
        ...
        >
          ...
          <div className="relative z-10 h-full w-full p-5 sm:p-6 flex flex-col justify-between">
            ...
            <div className="flex justify-between items-start">
              <div
                className="text-white font-black text-xl sm:text-2xl tracking-wide drop-shadow-xl"
                style={{ textShadow: "2px 2px 4px rgba(0,0,0,0.8)" }}
              >
                SE ELECTRONICS
              </div>
              <div className="flex items-center gap-3 border border-white/30 rounded-lg px-3 py-1.5 bg-transparent backdrop-blur-sm">
                <div className="text-right flex flex-col justify-center">
                  <div className="font-bold text-base leading-tight tracking-wider">
                    VIP CARD
                  </div>
                  <div className="text-[9px] font-semibold tracking-widest text-blue-100 uppercase">
                    MEMBER SHIP
                  </div>
                </div>
            ...
            <div className="w-full flex justify-center mt-6">
              <div className="text-[27px] tracking-[0.2em] font-medium drop-shadow-md">
                {vipCardNumber
            ...
            <div className="w-full flex justify-end pr-8 mt-1">
              <div className="flex items-center gap-2">
                <div className="flex flex-col text-[8px] font-bold text-right leading-none tracking-widest drop-shadow-md">
                  <span>EXPIRES</span>
                  <span>END</span>
                </div>
                <div className="text-lg font-medium tracking-wider drop-shadow-md">
            ...
            <div className="flex justify-between items-end">
              <div className="flex flex-col">
                <span className="text-[10px] sm:text-xs text-blue-300 uppercase tracking-widest font-bold mb-0.5">
                  CARD HOLDER
                </span>
                <span className="text-sm sm:text-base font-bold uppercase tracking-wider drop-shadow-md">
                  {customer.name}
                </span>
              </div>
            </div>
        ...
        >
          ...
          <div className="relative z-10 h-full w-full flex flex-col">
            ...
            {/* White Strip */}
            <div className="bg-white text-[#0A1128] w-full py-2 px-6 shadow-sm flex items-center">
              <span className="font-extrabold text-[15px] sm:text-[17px] tracking-wide uppercase">
            ...
            <div className="flex-1 px-6 py-2 flex flex-col justify-between">
              <div>
                <div className="font-semibold text-sm tracking-widest uppercase mb-4 drop-shadow-md">
                ...
                <div className="flex items-end gap-4">
                  ...
                  <div className="flex flex-col items-center gap-1">
                    <div className="text-white text-[10px] leading-tight font-medium text-center">
                      scan customer
                      <br />
                      profile login
                    </div>
                    <div className="bg-white p-1 rounded-sm w-16 h-16 sm:w-20 sm:h-20 shadow-md">
                      <img
                  ...
                  {/* Barcode Section */}
                  <div className="flex-1 h-12 sm:h-14 bg-white rounded-sm flex items-center justify-center p-2 shadow-md">
                    <div
                      className="w-full h-full opacity-90"
                      style={{
            ...
            {/* Footer Section */}
            <div className="bg-[#050A1A]/80 backdrop-blur-md w-full py-4 px-6 flex justify-between items-center border-t border-white/10">
              <div className="text-[9px] sm:text-[11px] leading-tight font-medium text-white/90">
                <p className="mb-0.5">
                  Customer care: 09649355555, 01322247774
                </p>
                <p>Office: Airport road, Badam Bagicha 2 No Road, Sylhet</p>
              </div>
              <Crown size={22} className="text-white opacity-90 ml-2" />
            </div>
          </div>
        </div>
      </div>
